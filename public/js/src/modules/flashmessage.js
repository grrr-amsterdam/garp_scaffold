...
Garp.FlashMessage = function(msg, timeout) {
  ...
  var setRemoveHandler = function(transition) {
    var events = transition ? styling.transitionEndEvents : styling.animationEndEvents;
  ...
  var hide = function() {
    ...
    var t = styling.getStyle(fm, styling.getTransitionProperty()),
      a = styling.getStyle(fm, styling.getAnimationProperty());
...
module.exports = Garp.FlashMessage;
