...
class Model_Base_AuthLocal extends Garp_Model_Db {
	...
	public function init() {
		...
		$this->registerObserver(new Garp_Model_Validator_NotEmpty(array('password', 'created', 'modified', 'user_id')));
	}
